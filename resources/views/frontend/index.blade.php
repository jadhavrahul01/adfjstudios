                ...
                <div class="offcanvas__top mb-10 d-flex justify-content-between align-items-center">
                    <div class="offcanvas__logo logo">
                        <a href="home-main.html">
                            <img
                                src="{{ url('frontend/img/logo/adfjlight.svg" alt="logo" height="75px" width="150px') }}" />
                        </a>
                    </div>
                </div>
    ...
    <main>
                    ...
                    <div class="row align-items-end">
                        <div class="col-xl-7 col-lg-6 col-md-7">
                            <div class="slider__content-9">
                                ...
                                <p>
                                    Where passion meets professionalism for extraordinary
                                    media productions
                                </p>
                        ...
                        <div class="col-xl-5 col-lg-6 col-md-5 order-first order-md-last">
                            <div class="slider__thumb-9 p-relative scene">
                                ...
                                <img class="slider__thumb-9-main" src="{{ url('frontend/img/slider/9/slider-1.png') }}"
                                    alt="" />
                            </div>
                        </div>
                    </div>
        ...
        <section class="about__area pt-30 pb-120 p-relative" id="about_page">
            <div class="about__shape">
                <img class="about__shape-3" src="{{ url('frontend/img/about/6/shape/about-shape-1.png') }}"
                    alt="" />
                <img class="about__shape-4" src="assets/img/about/6/shape/about-shape-2.png" alt="" />
                <img class="about__shape-5" src="assets/img/about/6/shape/about-shape-3.png" alt="" />
            </div>
                ...
                <div class="row">
                    <div class="col-xxl-5 col-xl-7 col-lg-6">
                        <div class="about__section-wrapper-6">
                            <div class="section__title-wrapper-6 mb-125">
                                <h3 class="section__title-6 about_title1">
                                    Creating Unforgettable Media
                                    <span class="section__title-6-highlight about_title2">
                                        Experiences.
                                        <svg width="201" height="11" viewBox="0 0 201 11" fill="none">
                                            <path class="wow" fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <div class="col-xxl-6 offset-xxl-1 col-xl-5 offset-xl-0 col-lg-5 offset-lg-1">
                        <div class="section__title-wrapper-6">
                            <p>
                                At AdFJ Studios, we are dedicated to crafting exceptional
                                audio and visual productions that captivate audiences. With
                                our passion for creativity and commitment to excellence, we
                                strive to deliver unforgettable media experiences that leave a
                                lasting impact.
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="about__features">
                            <div class="about__features-item d-flex align-items-start wow fadeInUp" data-wow-delay=".3s"
                                ...
                                <div class="about__features-content">
                                    <h3 class="about__features-title">Quality</h3>
                                    <p>Exceeding expectations with top-notch experiences</p>
                                </div>
                            </div>
                            <div class="about__features-item d-flex align-items-start wow fadeInUp" data-wow-delay=".5s"
                                ...
                                <div class="about__features-icon yellow-color">
                                    <span>
                                        <svg class="center-icon" width="35" height="35" viewBox="0 0 25 25"
                                            fill="none">
                                ...
                                <div class="about__features-content">
                                    <h3 class="about__features-title">Collaboration</h3>
                                    <p>Expertise and vision crafting remarkable media</p>
                                </div>
                            </div>
                            <div class="about__features-item d-flex align-items-start wow fadeInUp" data-wow-delay=".7s"
                                ...
                                <div class="about__features-content">
                                    <h3 class="about__features-title">Client-Centric</h3>
                                    <p>Prioritizing your satisfaction and responsiveness</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-9 col-xl-9 col-lg-8">
                        <div class="about__video-wrapper wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                            ...
                            <div class="about__video-thumb">
                                <img src="{{ url('frontend/img/about/6/about-1.jpg') }}" alt="" />
                                <div class="about__play">
                                    <a href="https://www.youtube.com/watch?v=3dXzH-quoTE"
                                        ...
                                        <img src="{{ url('frontend/img/about/6/about-play-icon.png') }}" alt="" />
                                    </a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        <div class="features__item transition-3 mb-30 wow fadeInUp" data-wow-delay=".3s"
                            data-wow-duration="1s">
                            <div class="features__icon">
                                <video autoplay loop muted plays-inline>
                                    <source src="{{ url('frontend/img/features/music-production.mp4') }}"
                                        type="video/mp4" />
                                </video>
                            </div>
                            <div class="features__content">
                                <h3 class="features__title">Music Production</h3>
                    ...
                    <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        <div class="features__item has-green transition-3 mb-30 wow fadeInUp" data-wow-delay=".5s"
                            data-wow-duration="1s">
                            <div class="features__icon icon-2">
                                <span>
                                    <video autoplay loop muted plays-inline style="transform: scale(1.5)">
                                        <source src="{{ url('frontend/img/features/audio-production.mp4') }}"
                                            type="video/mp4" />
                                    </video>
                                </span>
                            </div>
                            <div class="features__content">
                                <h3 class="features__title">Audio Engineering</h3>
                    ...
                    <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        <div class="features__item has-pink transition-3 mb-30 wow fadeInUp" data-wow-delay=".7s"
                            data-wow-duration="1s">
                            <div class="features__icon">
                                <span>
                                    <video autoplay loop muted plays-inline style="transform: scale(0.9)">
                                        <source src="{{ url('frontend/img/features/video-production.mp4') }}"
                                            type="video/mp4" />
                                    </video>
                                </span>
                            </div>
                            <div class="features__content">
                                <h3 class="features__title">Video Production</h3>
                    ...
                    <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        <div class="features__item has-purple transition-3 mb-30 wow fadeInUp" data-wow-delay=".9s"
                            data-wow-duration="1s">
                            <div class="features__icon">
                                <span>
                                    <video autoplay loop muted plays-inline>
                                        <source src="{{ url('frontend/img/features/graphic-production.mp4') }}"
                                            type="video/mp4" />
                                    </video>
                                </span>
                            </div>
                            <div class="features__content">
                                <h3 class="features__title">Graphic Design</h3>
                            ...
                            <div class="portfolio__slider-active">
                                ...
                                <div class="portfolio__item-3 transition-3 wow fadeInUp" data-wow-delay=".3s"
                                    ...
                                    <a href="https://petals-india.com/">
                                        <div class="portfolio__thumb-3 w-img"
                                            data-background="{{ url('frontend/img/portfolio/3/portfolio-5.jpg') }}"></div>
                                ...
                                <div class="portfolio__item-3 transition-3 wow fadeInUp" data-wow-delay=".3s"
                                    ...
                                    <a href="https://www.instagram.com/p/Ccos67BIgoK/">
                                        <div class="portfolio__thumb-3 w-img"
                                            data-background="{{ url('frontend/img/portfolio/3/portfolio-7.jpg') }}"></div>
                                        <div class="portfolio__content-3 transition-3">
                                            <div class="portfolio__tag-3">
                                ...
                                <div class="portfolio__item-3 transition-3 wow fadeInUp" data-wow-delay=".3s"
                                    ...
                                    <a href="https://www.youtube.com/watch?v=_BtGT-maCV0">
                                        <div class="portfolio__thumb-3 w-img"
                                            data-background="{{ url('frontend/img/portfolio/3/portfolio-3.jpg') }}"></div>
                                        <div class="portfolio__content-3 transition-3">
                                            <div class="portfolio__tag-3">
                                                <a href="#">Video Production</a>
                                            </div>
                                ...
                                <div class="portfolio__item-3 transition-3 wow fadeInUp" data-wow-delay=".3s"
                                    ...
                                    <a href="https://www.youtube.com/watch?v=SX_T7gK8mpE">
                                        <div class="portfolio__thumb-3 w-img"
                                            data-background="{{ url('frontend/img/portfolio/3/portfolio-4.jpg') }}"></div>
                                        <div class="portfolio__content-3 transition-3">
                                            <div class="portfolio__tag-3">
                                                <a href="#">Video Production</a>
                                            </div>
                                ...
                                <div class="portfolio__item-3 transition-3 wow fadeInUp" data-wow-delay=".3s"
                                    ...
                                    <a href="https://www.youtube.com/watch?v=IFEvDlO1CKg">
                                        <div class="portfolio__thumb-3 w-img"
                                            data-background="{{ url('frontend/img/portfolio/3/portfolio-6.jpg') }}"></div>
                                        <div class="portfolio__content-3 transition-3">
                                            <div class="portfolio__tag-3">
                                ...
                                <div class="row flex-row text-center align-items-center justify-content-center">
                                    <div class="col-xxl-3 col-md-6 col-sm-6 col-6">
                                        <div class=" skill1">
                                            <div class="skill__icon-9">
                                                <span>
                                                    <img src="{{ url('frontend/img/logo/logic-pro.png') }}"
                                                        alt="" height="55px" />
                                                </span>
                                            </div>
                                    ...
                                    <div class="col-xxl-3 col-md-6 col-sm-6 col-6">
                                        <div class="">
                                            <div class="skill__icon-9">
                                                <span>
                                                    <img src="{{ url('frontend/img/logo/pro-tools.png') }}"
                                                        alt="" height="55px" />
                                                </span>
                                            </div>
                                            <div class="skill__content-9">
                                ...
                                > -->
                                    ...
                                    <div class="col-xxl-3 col-md-6 col-sm-6 col-6">
                                        <div class="skill__item-9 skill1">
                                            <div class="skill__icon-9">
                                                <span>
                                                    <img src="{{ url('frontend/img/logo/premiere-pro.png') }}"
                                                        alt="" height="55px" />
                                                </span>
                                            </div>
                                            <div class="skill__content-9">
                                ...
                                > -->
                                    ...
                                    <div class="col-xxl-3 col-md-6 col-sm-6 col-6">
                                        <div class="">
                                            <div class="skill__icon-9">
                                                <span>
                                                    <img src="{{ url('frontend/img/logo/Adobe Ae.png') }}" alt=""
                                                        height="60px" />
                                                </span>
                                            </div>
                                            <div class="skill__content-9">
                    ...
                    <div class="about__gallery-slider-active">
                      <div class="about__gallery-item">
                        <div class="about__gallery-thumb m-img">
                          <img
                          src="{{url('frontend/img/portfolio/details/slider/portfolio-details-slider-3.jpg')}}"                            alt=""
                          />
                        </div>
                      </div>
                      <div class="about__gallery-item">
                      ...
                      <div class="about__gallery-item">
                        <div class="about__gallery-thumb m-img">
                          <img
                          src="{{url('frontend/img/portfolio/details/slider/portfolio-details-slider-3.jpg')}}"
                            alt=""
                          />
                        </div>
                      </div>
            ...
            <div class="container">
                    ...
                    <div class="col-xxl-6 col-xl-6 col-lg-8 col-md-8 col-sm-10">
                        <div class="section__title-wrapper text-center mb-60">
                            <h3 class="section__title">
                                ...
                                <span class="section__title-highlight">articles<svg width="220" height="27"
                                        viewBox="0 0 220 27" fill="none">
                                        <path
                ...
                <div class="row">
                    <div class="col-xxl-6 col-xl-6 col-lg-6">
                        <div class="blog__item white-bg transition-3 mb-30 wow fadeInUp" data-wow-delay=".3s"
                            data-wow-duration="1s">
                            <div class="row">
                                <div class="col-xxl-5 col-xl-5">
                                    <div class="blog__thumb m-img fix">
                                        ...
                                        <a href="blog-details.html">
                                            <img src="{{ url('frontend/img/blog/1/blog-1.jpg') }}" alt="" />
                                        </a>
                                    </div>
                                </div>
                                <div class="col-xxl-7 col-xl-7">
                                    <div class="blog__content">
                                        ...
                                        <h3 class="blog__title">
                                            <a href="blog-details.html">Helping BIPOC employees fight burnout and find
                                                community</a>
                                        </h3>
                    ...
                    <div class="col-xxl-6 col-xl-6 col-lg-6">
                        <div class="blog__item white-bg transition-3 mb-30 wow fadeInUp" data-wow-delay=".5s"
                            data-wow-duration="1s">
                            <div class="row">
                                <div class="col-xxl-5 col-xl-5">
                                    <div class="blog__thumb m-img fix">
                                        <div class="tp-thumb-overlay wow"></div>
                                        <a href="blog-details.html">
                                            <img src="{{ url('frontend/img/blog/1/blog-2.jpg') }}" alt="" />
                                        </a>
                                    </div>
                                </div>
                                <div class="col-xxl-7 col-xl-7">
                                    <div class="blog__content">
                                        ...
                                        <h3 class="blog__title">
                                            <a href="blog-details.html">How To Build Trust, Increase Authority, And Rank
                                                High
                                                With Google</a>
                                        </h3>
                                        <div class="blog__meta">
                    ...
                    <div class="col-xxl-6 col-xl-6 col-lg-6">
                        <div class="blog__item white-bg transition-3 mb-30 wow fadeInUp" data-wow-delay=".7s"
                            data-wow-duration="1s">
                            <div class="row">
                                <div class="col-xxl-5 col-xl-5">
                                    <div class="blog__thumb m-img fix">
                                        <div class="tp-thumb-overlay wow"></div>
                                        <a href="blog-details.html">
                                            <img src="{{ url('frontend/img/blog/1/blog-3.jpg') }}" alt="" />
                                        </a>
                                    </div>
                                </div>
                                <div class="col-xxl-7 col-xl-7">
                    ...
                    <div class="col-xxl-6 col-xl-6 col-lg-6">
                        <div class="blog__item white-bg transition-3 mb-30 wow fadeInUp" data-wow-delay=".9s"
                            data-wow-duration="1s">
                            <div class="row">
                                <div class="col-xxl-5 col-xl-5">
                                    <div class="blog__thumb m-img fix">
                                        <div class="tp-thumb-overlay wow"></div>
                                        <a href="blog-details.html">
                                            <img src="{{ url('frontend/img/blog/1/blog-4.jpg') }}" alt="" />
                                        </a>
                                    </div>
                                </div>
                                <div class="col-xxl-7 col-xl-7">
                                    <div class="blog__content">
                                        ...
                                        <h3 class="blog__title">
                                            <a href="blog-details.html">I stopped checking social media before noon,
                                                Here’s
                                                how it improved.</a>
                                        </h3>
                                        <div class="blog__meta">
        ...
        <section class="testimonial__area pt-50 grey-bg-7 fix">
            <div class="container">
                <div class="row align-items-end">
                    ...
                    <div class="col-xxl-6 col-xl-3 col-lg-3 col-md-3">
                        <div class="testimonial__slider-arrow-6 text-md-end mb-65">
                            <button class="testimonial-6-button-prev">
                                <i class="fa-regular fa-chevron-left"></i>
                            </button>
                            <button class="testimonial-6-button-next">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="testimonial__item-6 transition-3 mb-75 swiper-slide">
                                        ...
                                        <div class="testimonial__content-6">
                                            <p>
                                                I have been working with ADFJ studios since 6 months.
                                                Their team is highly responsive, always open for new
                                                ideas and they ...
                                            </p>
                                        </div>
                                        <div class="testimonial__avater-6 d-flex align-items-center">
                                            <div class="testimonial__avater-thumb-6">
                                                <img src="{{ url('frontend/img/review/one.png') }}" alt="" />
                                            </div>
                                    ...
                                    <div class="testimonial__item-6 transition-3 mb-75 swiper-slide">
                                        ...
                                        <div class="testimonial__content-6">
                                            <p>
                                                One of the best logo designed by them. Very
                                                cooperative people did everything told and at last
                                                delivered what I was looking for.
                                            </p>
                                        </div>
                                        <div class="testimonial__avater-6 d-flex align-items-center">
                                            <div class="testimonial__avater-thumb-6">
                                                <img src="{{ url('frontend/img/review/two.png') }}" alt="" />
                                            </div>
                                            <div class="testimonial__avater-info-6">
                                                <h3 class="testimonial__avater-title-6">
                                                    Sadafal India
                                    ...
                                    <div class="testimonial__item-6 transition-3 mb-75 swiper-slide">
                                        ...
                                        <div class="testimonial__content-6">
                                            <p>
                                                A very young boy works as an engineer here. Great
                                                music arranger. Here are some of the best recorded
                                                songs on YouTube.
                                            </p>
                                        </div>
                                        <div class="testimonial__avater-6 d-flex align-items-center">
                                            <div class="testimonial__avater-thumb-6">
                                                <img src="{{ url('frontend/img/review/three.png') }}" alt="" />
                                            </div>
                                            <div class="testimonial__avater-info-6">
                                                <h3 class="testimonial__avater-title-6">
                                                    Karan Raut
                                    ...
                                    <div class="testimonial__item-6 transition-3 mb-75 swiper-slide">
                                        ...
                                        <div class="testimonial__content-6">
                                            <p>
                                                Audio recording facility available here. New song
                                                recording & cover music production I love his work so
                                                much.
                                            </p>
                                        </div>
                                        <div class="testimonial__avater-6 d-flex align-items-center">
                                            <div class="testimonial__avater-thumb-6">
                                                <img src="{{ url('frontend//img/review/four.png') }}" alt="" />
                                            </div>
                                            <div class="testimonial__avater-info-6">
                                                <h3 class="testimonial__avater-title-6">
                                                    Kishan Yadav
        ...
        <section class="brand__area grey-bg-7">
            <div class="container">
                ...
                <div class="brand__item-wrapper-6 d-flex flex-wrap justify-content-between">
                    ...
                    <div class="brand__item-6">
                        <img src="{{ url('frontend/img/client/client2.png') }}" alt="" />
                    </div>
                    <div class="brand__item-6">
                        <img src="{{ url('frontend/img/client/client3.png') }}" alt="" />
                    </div>
                    <div class="brand__item-6">
                        <img src="{{ url('frontend/img/client/client4.png') }}" alt="" />
                    </div>
                    <div class="brand__item-6">
                                ...
                                <div class="contact__list-item-9 flex-wrap d-flex align-items-start">
                                    <div class="contact__list-icon-9">
                                        <span>
                                            ...
                                            <img class="contact-icon-shape"
                                                src="{{ url('frontend/img/contact/contact-icon-shape.png') }}"
                                                alt="" />
                                        </span>
                                    </div>
