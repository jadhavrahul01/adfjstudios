...
<html class="no-js" lang="zxx">
  <!-- portfolio.html12:38:29 GMT -->
  <head>
    <meta charset="utf-8" />
    <meta http-equiv="x-ua-compatible" content="ie=edge" />
    <title>AdFJ Studios - Portfoilo</title>
  ...
  <body>
          ...
          <div class="container">
            <div class="mega-menu-wrapper p-relative">
              <div class="row align-items-center">
                    ...
                    <nav id="mobile-menu">
                      <ul>
                        <li class="">
                          ...
                          <!-- <ul class="submenu">
                               <li><a href="home-main.html">About</a></li>
                ...
                <div
                  class="col-xxl-2 col-xl-2 col-lg-2 col-md-8 col-sm-7 col-4"
                >
                  <div
                    class="header__bottom-right-8 d-flex justify-content-end align-items-center"
                  >
      ...
      <section class="portfolio__area pt-110 pb-75 p-relative fix">
        ...
        <div class="container">
          ...
          <div class="row tp-gx-4 grid tp-portfolio-load-more" data-show="9">
            <div
              class="col-xl-4 col-lg-4 col-md-6 tp-portfolio grid-item cat1 cat4 cat2"
            >
              <div
              ...
              >
                <div class="portfolio__grid-thumb w-img fix">
                  ...
                  <div class="portfolio__grid-popup">
                    <a
                      href="assets/img/portfolio/grid/portfolio-grid-1.jpg"
                      class="popup-image"
                    >
                      <svg
                        width="15"
                ...
                <div class="portfolio__grid-content">
                  <h3 class="portfolio__grid-title">
                    <a href="portfolio-details.html">Magazine Cover</a>
                  </h3>
            ...
            <div
              class="col-xl-4 col-lg-4 col-md-6 tp-portfolio grid-item cat3 cat4 cat5"
            >
              <div
                class="portfolio__grid-item mb-40 wow fadeInUp"
                data-wow-delay=".3s"
              ...
              >
                <div class="portfolio__grid-thumb w-img fix">
                  ...
                  <div class="portfolio__grid-popup">
                    <a
                      href="assets/img/portfolio/grid/portfolio-grid-2.jpg"
                      class="popup-image"
                    >
                      <svg
                        width="15"
                ...
                <div class="portfolio__grid-content">
                  <h3 class="portfolio__grid-title">
                    <a href="portfolio-details.html">Logo Mockups</a>
                  </h3>
                  <div class="portfolio__grid-bottom">
                    <div class="portfolio__grid-category">
                      <span>
            ...
            <div
              class="col-xl-4 col-lg-4 col-md-6 tp-portfolio grid-item cat2 cat1 cat5"
            >
              <div
                class="portfolio__grid-item mb-40 wow fadeInUp"
                data-wow-delay=".3s"
              ...
              >
                <div class="portfolio__grid-thumb w-img fix">
                  ...
                  <div class="portfolio__grid-popup">
                    <a
                      href="assets/img/portfolio/grid/portfolio-grid-3.jpg"
                      class="popup-image"
                    >
                      <svg
                        width="15"
                ...
                <div class="portfolio__grid-content">
                  <h3 class="portfolio__grid-title">
                    <a href="portfolio-details.html">Pattern Inspired</a>
                  </h3>
                  <div class="portfolio__grid-bottom">
                    <div class="portfolio__grid-category">
                      <span>
            ...
            <div
              class="col-xl-4 col-lg-4 col-md-6 tp-portfolio grid-item cat4 cat2 cat3"
            >
              <div
                class="portfolio__grid-item mb-40 wow fadeInUp"
                data-wow-delay=".3s"
              ...
              >
                <div class="portfolio__grid-thumb w-img fix">
                  ...
                  <div class="portfolio__grid-popup">
                    <a
                      href="assets/img/portfolio/grid/portfolio-grid-4.jpg"
                      class="popup-image"
                    >
                      <svg
                        width="15"
            ...
            <div
              class="col-xl-4 col-lg-4 col-md-6 tp-portfolio grid-item cat1 cat3 cat4"
            >
              <div
                class="portfolio__grid-item mb-40 wow fadeInUp"
                data-wow-delay=".3s"
              ...
              >
                <div class="portfolio__grid-thumb w-img fix">
                  ...
                  <div class="portfolio__grid-popup">
                    <a
                      href="assets/img/portfolio/grid/portfolio-grid-5.jpg"
                      class="popup-image"
                    >
                      <svg
                        width="15"
                ...
                <div class="portfolio__grid-content">
                  <h3 class="portfolio__grid-title">
                    <a href="portfolio-details.html">Branding Design</a>
                  </h3>
                  <div class="portfolio__grid-bottom">
                    <div class="portfolio__grid-category">
                      <span>
            ...
            <div
              class="col-xl-4 col-lg-4 col-md-6 tp-portfolio grid-item cat3 cat2 cat5"
            >
              <div
                class="portfolio__grid-item mb-40 wow fadeInUp"
                data-wow-delay=".3s"
              ...
              >
                ...
                <div class="portfolio__grid-content">
                  <h3 class="portfolio__grid-title">
                    <a href="portfolio-details.html">Original Coffee</a>
                  </h3>
                  <div class="portfolio__grid-bottom">
                    <div class="portfolio__grid-category">
                      <span>
            ...
            >
              ...
              >
                <div class="portfolio__grid-thumb w-img fix">
                  ...
                  <div class="portfolio__grid-popup">
                    <a
                      href="assets/img/portfolio/grid/portfolio-grid-7.jpg"
                      class="popup-image"
                    >
                      <svg
                        width="15"
                ...
                <div class="portfolio__grid-content">
                  <h3 class="portfolio__grid-title">
                    <a href="portfolio-details.html">Visual Identity</a>
                  </h3>
                  <div class="portfolio__grid-bottom">
                    <div class="portfolio__grid-category">
                      <span>
            ...
            >
              ...
              >
                ...
                <div class="portfolio__grid-content">
                  <h3 class="portfolio__grid-title">
                    <a href="portfolio-details.html">UX Web Design</a>
                  </h3>
                  <div class="portfolio__grid-bottom">
                    <div class="portfolio__grid-category">
                      <span>
            ...
            >
              ...
              >
                <div class="portfolio__grid-thumb w-img fix">
                  ...
                  <div class="portfolio__grid-popup">
                    <a
                      href="assets/img/portfolio/grid/portfolio-grid-9.jpg"
                      class="popup-image"
                    >
                      <svg
                        width="15"
            ...
            >
              ...
              >
                <div class="portfolio__grid-thumb w-img fix">
                  ...
                  <div class="portfolio__grid-popup">
                    <a
                      href="assets/img/portfolio/grid/portfolio-grid-10.jpg"
                      class="popup-image"
                    >
                      <svg
                        width="15"
            ...
            >
              ...
              >
                <div class="portfolio__grid-thumb w-img fix">
                  ...
                  <div class="portfolio__grid-popup">
                    <a
                      href="assets/img/portfolio/grid/portfolio-grid-12.jpg"
                      class="popup-image"
                    >
                      <svg
                        width="15"
    ...
    <footer>
      <div
        class="footer__area p-relative z-index-1"
        data-bg-color="footer-bg-black-2"
      >
        <div
          class="footer__bg"
          data-background="assets/img/footer/footer-shape-2.jpg"
        ></div>
                ...
                <div class="footer__widget-6 mb-50 footer-col-6-1">
                  ...
                  <div class="footer__widget-content">
                    <div class="footer__info">
                      <p>
                        Unleashing Creativity. Elevating Media Productions. AdFJ
                    ...
                    <div class="footer__info">
                      <div class="footer__info-item-6 d-flex align-items-start">
                        ...
                        <div class="footer__info-text-6">
                          <a
                            target="https://goo.gl/maps/HQLFWmBQ75PordVB9"
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="footer__copyright-6">
                    <p>
                      <a href="home-main.html">© 2022 AdFJ Studios</a> All
                      Rights Reserved.
                    </p>
                  </div>
                </div>
