            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="contact__item text-center mb-30 transition-3 white-bg">
                            <div class="contact__icon">
                                <img src="{{ url('frontend/img/contact/icon/contact-icon-1.png') }}" alt="" />
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="contact__item text-center mb-30 transition-3 white-bg">
                            <div class="contact__icon">
                                <img src="{{ url('frontend/img/contact/icon/contact-icon-3.png') }}" alt="" />
                            </div>
                            <div class="contact__content">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="contact__item text-center mb-30 transition-3 white-bg">
                            <div class="contact__icon">
                                <img src="{{ url('frontend/img/contact/icon/contact-icon-2.png') }}" alt="" />
                            </div>
                            <div class="contact__content">
