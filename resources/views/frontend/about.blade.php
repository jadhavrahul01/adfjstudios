        ...
        <div class="container">
          <div class="row">
            <div class="col-xl-4 col-lg-4">
              <div
                class="about__text-wrapper wow fadeInUp"
                data-wow-delay=".3s"
            ...
            <div class="col-xl-8 col-lg-8">
              <div
                class="about__text wow fadeInUp"
                data-wow-delay=".6s"
                data-wow-duration="1s"
              >
                <p>
                      ...
                      <div class="award__content-9">
                        <h3 class="award__title-9">
                          <a
                            href="javascript:void(0)"
                            class="tp-img-reveal tp-img-reveal-item"
                            data-img="assets/img/award/9/award-4.jpg"
                            data-fx="1"
                            >Awwwards site of the day</a
                          >
                        </h3>
                        <p>Runner Up - “ Decor of the week “</p>
                      </div>
      ...
      <section class="faq__area p-relative">
        <div class="faq__video" data-background="{{url('frontend/img/faq/faq-img.jpg')}}">
          <div class="faq__video-btn">
            <a
              href="https://www.youtube.com/watch?v=3dXzH-quoTE"
              ...
              >
                <div class="faq__title-wrapper">
                  <span class="faq__title-pre"
                    >Experience the Power of Media Production</span
                  >
                  <h3 class="faq__title">
