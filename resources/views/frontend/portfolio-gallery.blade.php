...
<html class="no-js" lang="zxx">
  <!-- portfolio-gallery.html12:38:34 GMT -->
  <head>
    <meta charset="utf-8" />
    <meta http-equiv="x-ua-compatible" content="ie=edge" />
    <title>Portfolio Gallery - Harry</title>
  ...
  <body>
          ...
          <div class="preloader__content text-center">
            ...
            <div class="preloader__with-text">
              <div class="preloader__with-text-wrapper">
                <span data-text-preloader="h" class="preloader__title-2"
                  >h</span
                >
                <span data-text-preloader="a" class="preloader__title-2"
                  >a</span
                >
                <span data-text-preloader="r" class="preloader__title-2"
                  >r</span
                >
                <span data-text-preloader="r" class="preloader__title-2"
                  >r</span
                >
                <span data-text-preloader="y" class="preloader__title-2"
                  >y</span
                >
              </div>
            </div>
          ...
          <div class="container">
            <div class="mega-menu-wrapper p-relative">
              <div class="row align-items-center">
                      ...
                      <ul>
                        <li class="has-dropdown">
                          ...
                          <ul class="submenu">
                            ...
                            <li>
                              <a href="home-agency.html">Digital Agency</a>
                            </li>
                            <li>
                            ...
                            <li>
                              <a href="home-creative.html">Creative Agency</a>
                            </li>
                            <li>
                              <a href="home-portfolio.html"
                                >Personal Portfolio</a
                              >
                            </li>
                            <li>
                              <a href="home-architecture.html">Architechture</a>
                            </li>
                            <li>
                              <a href="home-vertical.html">Vertical Slider</a>
                            </li>
                            <li>
                              <a href="home-politician.html">Politician</a>
                            </li>
                            <li><a href="home-shop.html">Minimal Shop</a></li>
                            <li>
                              <a href="home-swipper.html">Swipper Slider</a>
                            </li>
                          </ul>
                        </li>
                          ...
                          <ul class="mega-menu">
                            <li>
                              ...
                              <ul>
                                ...
                                <li>
                                  <a href="elements-blog-post.html"
                                    >Blog Posts</a
                                  >
                                </li>
                                <li>
                        ...
                        <li class="has-dropdown">
                          ...
                          <ul class="submenu">
                            ...
                            <li>
                              <a href="portfolio-2.html">Grid 3 Columns</a>
                            </li>
                            <li>
                              <a href="portfolio-gallery.html">Gallery Style</a>
                            </li>
                            <li>
                            ...
                            <li>
                              <a href="portfolio-metro.html">Metro Style</a>
                            </li>
                            <li>
                            ...
                            <li>
                              <a href="portfolio-details-slider.html"
                                >Slider with Details</a
                              >
                            </li>
                            <li>
                              <a href="portfolio-details-video.html"
                                >Video With Details</a
                              >
                            </li>
                          </ul>
                        </li>
                        ...
                        <li class="has-dropdown">
                          ...
                          <ul class="submenu">
                            ...
                            <li>
                              <a href="blog-grid-2.html">Blog Grid Boxed</a>
                            </li>
                            <li>
                          ...
                          <ul class="mega-menu">
                            <li>
                              ...
                              <ul>
                                ...
                                <li>
                                  <a href="services.html">Service Creative</a>
                                </li>
                                <li>
                                  <a href="services-2.html">Service Standard</a>
                                </li>
                                <li>
                                  <a href="services-3.html">Service Basic</a>
                                </li>
                                <li>
                            ...
                            <li>
                              ...
                              <ul>
                                <li><a href="team.html">Team Classic</a></li>
                                <li>
                                ...
                                <li><a href="job.html">Job List</a></li>
                                <li>
                        ...
                        <li class="has-dropdown">
                          ...
                          <ul class="submenu">
                            <li><a href="contact.html">Contact Agency </a></li>
                            <li>
                              <a href="contact-2.html">Contact: Classic</a>
                            </li>
                          </ul>
                        </li>
                      </ul>
                ...
                <div
                  class="col-xxl-3 col-xl-2 col-lg-2 col-md-8 col-sm-7 col-4"
                >
                  <div
    ...
    <main>
      ...
      <section class="portfolio__area pt-110 pb-80 p-relative fix">
        ...
        <div class="container">
          <div class="row">
            <div class="col-xl-12">
              <div class="portfolio__section-title-wrapper text-center mb-90">
                ...
                >
                <h3 class="portfolio__section-title">Portfolio Gallery</h3>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-xxl-12">
              <div class="portfolio__masonary-btn text-center mb-40">
                <div class="masonary-menu filter-button-group">
                  ...
                  <button data-filter=".cat2">Branding <span>05</span></button>
                  <button data-filter=".cat3">Creative <span>12</span></button>
                  <button data-filter=".cat4">Packaging <span>07</span></button>
                  <button data-filter=".cat5">Mockup <span>01</span></button>
                </div>
              </div>
            </div>
          </div>
          ...
          >
            <div class="col-xl-4 col-lg-4 col-md-6 grid-item cat1 cat3">
              <div
                class="portfolio__grid-item mb-40 wow fadeInUp"
                data-wow-delay=".3s"
                data-wow-duration="1s"
              >
                <div
                  class="portfolio__grid-thumb w-img fix tp-img-reveal tp-img-reveal-item"
                  data-fx="24"
                  data-meta-tag="Creative"
                  data-title="Visual Identity"
                >
                  <a href="portfolio-details.html">
                    <img
                      src="assets/img/portfolio/grid/portfolio-grid-1.jpg"
                      alt=""
                    />
                  </a>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 grid-item cat2 cat4">
              ...
              >
                <div
                  class="portfolio__grid-thumb w-img fix tp-img-reveal tp-img-reveal-item"
                  data-fx="24"
                  data-meta-tag="Packaging"
                  data-title="Logo Mockups"
                >
                  <a href="portfolio-details.html">
                    <img
                      src="assets/img/portfolio/grid/portfolio-grid-2.jpg"
                      alt=""
                    />
                  </a>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 grid-item cat3 cat2 cat1">
              <div
                class="portfolio__grid-item mb-40 wow fadeInUp"
                data-wow-delay=".3s"
                data-wow-duration="1s"
              >
                <div
                  ...
                  data-fx="24"
                  data-meta-tag="Apps"
                  data-title="Pattern Inspired"
                >
                  <a href="portfolio-details.html">
                    <img
                      src="assets/img/portfolio/grid/portfolio-grid-3.jpg"
                      alt=""
                    />
                  </a>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 grid-item cat4 cat1">
              <div
                class="portfolio__grid-item mb-40 wow fadeInUp"
                data-wow-delay=".3s"
                data-wow-duration="1s"
              >
                <div
                  class="portfolio__grid-thumb w-img fix tp-img-reveal tp-img-reveal-item"
                  data-fx="24"
                  data-meta-tag="Branding"
                  data-title="Product Design"
                >
                  <a href="portfolio-details.html">
                    <img
                      src="assets/img/portfolio/grid/portfolio-grid-4.jpg"
                      alt=""
                    />
                  </a>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 grid-item cat5 cat3">
              ...
              >
                <div
                  ...
                  data-fx="24"
                  data-meta-tag="Creative"
                  data-title="Original Coffee"
                >
                  <a href="portfolio-details.html">
                    <img
                      src="assets/img/portfolio/grid/portfolio-grid-5.jpg"
                      alt=""
                    />
                  </a>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 grid-item cat2 cat1">
              ...
              >
                <div
                  class="portfolio__grid-thumb w-img fix tp-img-reveal tp-img-reveal-item"
                  data-fx="24"
                  data-meta-tag="Development"
                  data-title="UX Web Design"
                >
                  <a href="portfolio-details.html">
                    <img
                      src="assets/img/portfolio/grid/portfolio-grid-6.jpg"
                      alt=""
                    />
                  </a>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 grid-item cat1 cat2">
              ...
              >
                ...
                >
                  <a href="portfolio-details.html">
                    <img
                      src="assets/img/portfolio/grid/portfolio-grid-7.jpg"
                      alt=""
                    />
                  </a>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 grid-item cat3 cat5">
              ...
              >
                <div
                  class="portfolio__grid-thumb w-img fix tp-img-reveal tp-img-reveal-item"
                  data-fx="24"
                  data-meta-tag="Decoration"
                  data-title="Visual Identity"
                >
                  <a href="portfolio-details.html">
                    <img
                      src="assets/img/portfolio/grid/portfolio-grid-8.jpg"
                      alt=""
                    />
                  </a>
                  <div class="portfolio__grid-video">
                    <a
                      href="https://www.youtube.com/watch?v=go7QYaQR494&amp;t=3s"
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 grid-item cat5 cat4">
              <div
                class="portfolio__grid-item mb-40 wow fadeInUp"
                data-wow-delay=".3s"
                data-wow-duration="1s"
              >
                ...
                >
                  <a href="portfolio-details.html">
                    <img
                      src="assets/img/portfolio/grid/portfolio-grid-9.jpg"
                      alt=""
                    />
                  </a>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 grid-item cat5 cat4">
              ...
              >
                ...
                >
                  <a href="portfolio-details.html">
                    <img
                      src="assets/img/portfolio/grid/portfolio-grid-10.jpg"
                      alt=""
                    />
                  </a>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 grid-item cat5 cat4">
              ...
              >
                ...
                >
                  <a href="portfolio-details.html">
                    <img
                      src="assets/img/portfolio/grid/portfolio-grid-11.jpg"
                      alt=""
                    />
                  </a>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 grid-item cat5 cat4">
              ...
              >
                ...
                >
                  <a href="portfolio-details.html">
                    <img
                      src="assets/img/portfolio/grid/portfolio-grid-12.jpg"
                      alt=""
                    />
                  </a>
                </div>
            ...
            <div class="row">
              <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="footer__widget mb-50 footer-col-1">
                  ...
                  <div class="footer__widget-content p-relative z-index-1">
                        ...
                        <div class="footer__contact-call">
                          <span
                            ><a href="tel:624-423-26-72"
                              ><i class="fa-solid fa-phone"></i> +624 423 26
                              72</a
                            ></span
                          >
                        </div>
              ...
              <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="footer__widget mb-50 footer-col-3">
                  ...
                  <div class="footer__widget-content">
                    <ul>
                      <li><a href="job-details.html">Careers</a></li>
                      <li><a href="job.html">Job Post</a></li>
              ...
              <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="footer__widget mb-50 footer-col-4">
                  <h3 class="footer__widget-title">Downloads</h3>

                  <div class="footer__widget-content">
                    <div class="footer__app mb-30">
                      <div class="footer__app-item">
                        <a href="#" class="tp-btn-app"
                          ><svg
                            width="15"
                            height="16"
                            viewBox="0 0 15 16"
                          ...
                          >
                            <path
                              d="M6.72221 12.4448V14.7782C6.72221 15.206 6.3722 15.556 5.94442 15.556C5.51663 15.556 5.16663 15.206 5.16663 14.7782V12.4448H6.72221Z"
                              fill="currentColor"
                            />
                            <path
                              d="M9.83329 12.4448V14.7782C9.83329 15.206 9.48328 15.556 9.0555 15.556C8.62772 15.556 8.27771 15.206 8.27771 14.7782V12.4448H9.83329Z"
                              fill="currentColor"
                            />
                            <path
                              d="M11.3891 6.99992V10.8889C11.3891 11.7444 10.6891 12.4444 9.83352 12.4444H5.16679C4.31122 12.4444 3.61121 11.7444 3.61121 10.8889V6.99992C3.61121 6.14435 4.31122 5.44434 5.16679 5.44434H9.83352C10.6891 5.44434 11.3891 6.14435 11.3891 6.99992Z"
                              fill="currentColor"
                            />
                            <path
                              d="M2.05558 6.99947V10.1106C2.05558 10.5384 1.70557 10.8884 1.27779 10.8884C0.850005 10.8884 0.5 10.5384 0.5 10.1106V6.99947C0.5 6.57169 0.850005 6.22168 1.27779 6.22168C1.70557 6.22168 2.05558 6.57169 2.05558 6.99947Z"
                              fill="currentColor"
                            />
                            <path
                              d="M14.4999 6.99947V10.1106C14.4999 10.5384 14.1499 10.8884 13.7221 10.8884C13.2943 10.8884 12.9443 10.5384 12.9443 10.1106V6.99947C12.9443 6.57169 13.2943 6.22168 13.7221 6.22168C14.1499 6.22168 14.4999 6.57169 14.4999 6.99947Z"
                              fill="currentColor"
                            />
                            <path
                              d="M5.63336 4.35563H9.36679C10.0512 4.35563 10.6112 3.79561 10.6112 3.11116C10.6112 1.39224 9.21899 0 7.50008 0C5.78116 0 4.38892 1.39224 4.38892 3.11116C4.38892 3.79561 4.94891 4.35563 5.63336 4.35563Z"
                              fill="currentColor"
                            />
                          </svg>
                          Android</a
                    ...
                    <div class="footer__qrcode d-flex align-items-center">
                      <div class="footer__qrcode-thumb mr-10">
                        <a
                          class="popup-image"
                          href="assets/img/icon/qrcode.png"
                        >
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="footer__copyright">
                    <p>
                      <a href="home-main.html">© 2022 Harry</a> All Rights
                      Reserved.
                    </p>
                  </div>
                </div>
