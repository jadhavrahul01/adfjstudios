<footer>
  ...
  <!-- JS here -->
  <script src="{{url('frontend/js/vendor/jquery.js')}}"></script>
  <script src="{{url('frontend/js/vendor/waypoints.js')}}"></script>
  <script src="{{url('frontend/js/bootstrap-bundle.js')}}"></script>
  <script src="{{url('frontend/js/meanmenu.js')}}"></script>
  <script src="{{url('frontend/js/swiper-bundle.js')}}"></script>
  ...
  <script src="{{url('frontend/js/backtotop.js')}}"></script>
  ...
  <script src="{{url('frontend/js/charming.js')}}"></script>
  <script src="{{url('frontend/js/hover-reveal.js')}}"></script>
  <script src="{{url('frontend/js/tween-max.js')}}"></script>
  <script src="{{url('frontend/js/ajax-form.js')}}"></script>
  <script src="{{url('frontend/js/main.js')}}"></script>
</body>

<!-- home-portfolio.html12:37:30 GMT -->
</html>
