...
<html class="no-js" lang="zxx">
  <!-- search.html12:39:04 GMT -->
  <head>
    <meta charset="utf-8" />
    <meta http-equiv="x-ua-compatible" content="ie=edge" />
    <title>Search - Harry</title>
  ...
  <body>
    ...
    <main>
                      ...
                      <div class="search__result-input">
                        <span>
                          ...
                          >
                            ...
                            />
                            <path
                              d="M19.0031 19.0002L17.2031 17.2002"
                              stroke="currentColor"
                              stroke-width="1.5"
                              stroke-linecap="round"
                              stroke-linejoin="round"
      ...
      <section class="search__result-item-area pt-100 pb-120">
        <div class="container">
          <div class="row">
            <div class="col-md-6">
              <div class="search__blog-item mb-30">
                <div class="search__blog-content">
                  <div
                    class="search__blog-meta-wrapper d-flex flex-wrap align-items-center"
                  >
                  ...
                  <h3 class="search__blog-title">
                    <a href="blog-details.html"
                      ...
                      Australia joins US diplomatic.</a
                    >
                  </h3>
                  <p>
                    Everybody needs to write content for personal or
                    professional purposes. It can be anything.!
                  </p>

                  <div
                    class="search__blog-bottom d-flex flex-wrap align-items-center mb-20"
                  >
                    <div
                      class="search__blog-meta-author d-flex align-items-center mr-45"
                    >
                      ...
                      <div class="search__blog-meta-author-content">
                        <span>By<a href="#"> Weir Doe</a></span>
                      </div>
                    </div>
                    <div class="search__blog-meta">
                      <span>
                  ...
                  <div class="search__blog-btn">
                    <a href="blog-details.html" class="tp-btn-border">
                      Read More
                      <span>
                        <svg
                          width="26"
            ...
            <div class="col-md-6">
              <div class="search__blog-item mb-30">
                <div class="search__blog-content">
                  ...
                  <h3 class="search__blog-title">
                    <a href="blog-details.html"
                      >6 Product launch Email <br />Examples you’ll Want to
                      Steal.</a
                    >
                  </h3>
                  <p>
            ...
            <div class="col-md-6">
              <div class="search__blog-item mb-30">
                <div class="search__blog-content">
                  ...
                  <h3 class="search__blog-title">
                    <a href="blog-details.html"
                      >Top 10 Digital Marketing Tips to <br />
                      Get you More Views</a
                    >
                  </h3>
                  <p>
                    Everybody needs to write content for personal or
                  ...
                  >
                    ...
                    >
                      ...
                      <div class="search__blog-meta-author-content">
                        <span>By<a href="#"> Nutrisha</a></span>
                      </div>
                    </div>
                    <div class="search__blog-meta">
                      <span>
            ...
            <div class="col-md-6">
              <div class="search__blog-item mb-30">
                <div class="search__blog-content">
                  ...
                  <h3 class="search__blog-title">
                    <a href="blog-details.html"
                      >Create a Landing Page That Performs Great</a
                    >
                  </h3>
                  <p>
                    Everybody needs to write content for personal or
    ...
    <footer>
      <div
        class="footer__area footer__style-blue include-bg bg-luminosity"
        data-bg-color="footer-bg-blue"
        data-background="assets/img/footer/footer-shape-5.png"
      >
          ...
          <div class="container">
            <div class="row">
              <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div
                  class="footer__widget footer__widget-7 mb-50 footer-col-7-1"
                >
              ...
              <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div
                  class="footer__widget footer__widget-7 mb-50 footer-col-7-2"
                >
              ...
              <div class="col-xxl-2 col-xl-2 col-lg-3 col-md-6 col-sm-6">
                <div
                  class="footer__widget footer__widget-7 mb-50 footer-col-7-3"
                >
                  <h3 class="footer__widget-title-7">Resources</h3>
                  ...
                  >
                    ...
                    <div class="footer__lang-wrapper">
                      <span
                        ...
                        >English</span
                      >
                      <ul class="footer__lang-list tp-lang-list-2">
                        <li>Spanish</li>
                        <li>Portugese</li>
                        <li>American</li>
                        <li>Canada</li>
