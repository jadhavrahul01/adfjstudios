(function ($) {
  ...
  verticalslider1.on("slideChangeTransitionStart", function (realIndex) {
    if (
      ...
      $(".header__white, .slider-pagination-11").addClass(
        "header__white-slider slider-pagination-11-white"
      );
    } else {
      $(".header__white, .slider-pagination-11").removeClass(
        "header__white-slider slider-pagination-11-white"
      );
    }
  });
  ...
  verticalslider2.on("slideChangeTransitionStart", function (realIndex) {
    if (
      $(".swiper-slide.swiper-slide-active").hasClass("slider__item-12-dark")
    ) {
